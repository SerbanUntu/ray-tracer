...
Sphere::Sphere(Vec3 _center, double _radius, std::unique_ptr<const Material> _mat) : center(_center), radius(_radius), Object(std::move(_mat)) {}

Vec3 Sphere::get_center() const { return center; }

double Sphere::get_radius() const { return radius; }

double Sphere::ray_intersection(Ray r) const {
...
Vec3 Sphere::get_normal(Vec3 point) const {
